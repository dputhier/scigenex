...
```{r, term_network_1_MOD_MODULE_NUMBER, eval="module_term_network" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Cnetplot")
``` 


```{r, term_network_2_MOD_MODULE_NUMBER, eval="module_term_network" %in% section, echo=FALSE, results = "asis"}
...
```{r, term_network_3_MOD_MODULE_NUMBER, echo=FALSE, eval="module_term_network" %in% section }
...
```{r, term_network_circ_1_MOD_MODULE_NUMBER, eval="module_term_network_circ" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Cnetplot")
``` 

```{r, term_network_circ_2_MOD_MODULE_NUMBER, eval="module_term_network_circ" %in% section, echo=FALSE, results = "asis"}
knitr::asis_output("The cnetplot() with circular layout.") 
``` 

```{r, term_network_circ_3_MOD_MODULE_NUMBER, echo=FALSE, eval="module_term_network_circ" %in% section }
cnetplot_used_params <- as.list(formals(enrichplot:::cnetplot.enrichResult))
for(i in names(cnetplot_params)){cnetplot_used_params[[i]] <- cnetplot_params[[i]]}
# These guys are deprecated...
cnetplot_used_params <- cnetplot_used_params[!names(cnetplot_used_params) %in% c("foldChange", 
...
```{r, term_bp1_1_MOD_MODULE_NUMBER, eval="module_term_barplot_1" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Func. enr. barplot ")
``` 

```{r, term_bp1_2_MOD_MODULE_NUMBER, eval="module_term_barplot_1" %in% section, echo=FALSE, results = "asis"}
knitr::asis_output("Bar plot of enriched terms.") 
``` 

```{r, term_bp1_3_MOD_MODULE_NUMBER, echo=FALSE, eval="module_term_barplot_1" %in% section }
...
```{r, term_bp2_1_MOD_MODULE_NUMBER, eval="module_term_barplot_2" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Func. enr. dotplot ")
``` 

```{r, term_bp2_2_MOD_MODULE_NUMBER, eval="module_term_barplot_2" %in% section, echo=FALSE, results = "asis"}
knitr::asis_output("Dot plot of enriched terms.") 
``` 

```{r, term_bp2_3_MOD_MODULE_NUMBER, echo=FALSE, eval="module_term_barplot_2" %in% section }
if(nrow(enrich_res) > 0){
...
```{r, term_table_1_MOD_MODULE_NUMBER, eval="term_table" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Func. enr. table ")
``` 

```{r, term_table_2_MOD_MODULE_NUMBER, eval="term_table" %in% section, echo=FALSE, results = "asis"}
...
```{r, cc_term_network_1_MOD_MODULE_NUMBER, eval="module_term_network" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Cnetplot")
``` 


```{r, cc_term_network_2_MOD_MODULE_NUMBER, eval="module_term_network" %in% section, echo=FALSE, results = "asis"}
knitr::asis_output("The cnetplot() function from the clusterProfiler R package is used to visualize enriched functional categories (e.g., here GO BP) as a concept-gene network. It helps interpret the relationships between genes and the biological functions or pathways they are associated with. The cnetplot() function generates a bipartite network plot where nodes represent genes and terms (e.g., GO terms, pathways). Edges connect genes to the terms they are annotated with. The network helps illustrate how multiple terms share common genes, and how individual genes may be involved in multiple functions.") 
``` 

```{r, cc_term_network_3_MOD_MODULE_NUMBER, echo=FALSE, eval="module_term_network" %in% section }
...
```{r, cc_term_network_circ_1_MOD_MODULE_NUMBER, eval="module_term_network_circ" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Cnetplot")
``` 

```{r, cc_term_network_circ_2_MOD_MODULE_NUMBER, eval="module_term_network_circ" %in% section, echo=FALSE, results = "asis"}
knitr::asis_output("The cnetplot() with circular layout.") 
``` 

```{r, cc_term_network_circ_3_MOD_MODULE_NUMBER, echo=FALSE, eval="module_term_network_circ" %in% section }
cnetplot_used_params <- as.list(formals(enrichplot:::cnetplot.enrichResult))
for(i in names(cnetplot_params)){cnetplot_used_params[[i]] <- cnetplot_params[[i]]}
# These guys are deprecated...
cnetplot_used_params <- cnetplot_used_params[!names(cnetplot_used_params) %in% c("foldChange", 
...
```{r, cc_term_bp1_1_MOD_MODULE_NUMBER, eval="module_term_barplot_1" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Func. enr. barplot ")
``` 

```{r, cc_term_bp1_2_MOD_MODULE_NUMBER, eval="module_term_barplot_1" %in% section, echo=FALSE, results = "asis"}
knitr::asis_output("Bar plot of enriched terms.") 
``` 

```{r, cc_term_bp1_3_MOD_MODULE_NUMBER, echo=FALSE, eval="module_term_barplot_1" %in% section }
...
```{r, cc_term_bp2_1_MOD_MODULE_NUMBER, eval="module_term_barplot_2" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Func. enr. dotplot ")
``` 

```{r, cc_term_bp2_2_MOD_MODULE_NUMBER, eval="module_term_barplot_2" %in% section, echo=FALSE, results = "asis"}
knitr::asis_output("Dot plot of enriched terms.") 
``` 

```{r, cc_term_bp2_3_MOD_MODULE_NUMBER, echo=FALSE, eval="module_term_barplot_2" %in% section }
if(nrow(enrich_res) > 0){
  try_err <- try(enrichplot::dotplot(enrich_res, showCategory=15) + 
                   ggplot2::theme(axis.text.y = ggplot2::element_text(size=7)), silent = TRUE)
...
```{r, cc_term_table_1_MOD_MODULE_NUMBER, eval="term_table" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Func. enr. table ")
``` 

```{r, cc_term_table_2_MOD_MODULE_NUMBER, eval="term_table" %in% section, echo=FALSE, results = "asis"}
knitr::asis_output("A table with various information related to enrichment.") 
``` 
...
```{r, mf_term_network_1_MOD_MODULE_NUMBER, eval="module_term_network" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Cnetplot")
``` 


```{r, mf_term_network_2_MOD_MODULE_NUMBER, eval="module_term_network" %in% section, echo=FALSE, results = "asis"}
knitr::asis_output("The cnetplot() function from the clusterProfiler R package is used to visualize enriched functional categories (e.g., here GO BP) as a concept-gene network. It helps interpret the relationships between genes and the biological functions or pathways they are associated with. The cnetplot() function generates a bipartite network plot where nodes represent genes and terms (e.g., GO terms, pathways). Edges connect genes to the terms they are annotated with. The network helps illustrate how multiple terms share common genes, and how individual genes may be involved in multiple functions.") 
``` 

```{r, mf_term_network_3_MOD_MODULE_NUMBER, echo=FALSE, eval="module_term_network" %in% section }
...
```{r, mf_term_network_circ_1_MOD_MODULE_NUMBER, eval="module_term_network_circ" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Cnetplot")
``` 

```{r, mf_term_network_circ_2_MOD_MODULE_NUMBER, eval="module_term_network_circ" %in% section, echo=FALSE, results = "asis"}
knitr::asis_output("The cnetplot() with circular layout.") 
``` 

```{r, mf_term_network_circ_3_MOD_MODULE_NUMBER, echo=FALSE, eval="module_term_network_circ" %in% section }
cnetplot_used_params <- as.list(formals(enrichplot:::cnetplot.enrichResult))
for(i in names(cnetplot_params)){cnetplot_used_params[[i]] <- cnetplot_params[[i]]}
# These guys are deprecated...
cnetplot_used_params <- cnetplot_used_params[!names(cnetplot_used_params) %in% c("foldChange", 
...
```{r, mf_term_bp1_1_MOD_MODULE_NUMBER, eval="module_term_barplot_1" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Func. enr. barplot ")
``` 

```{r, mf_term_bp1_2_MOD_MODULE_NUMBER, eval="module_term_barplot_1" %in% section, echo=FALSE, results = "asis"}
knitr::asis_output("Bar plot of enriched terms.") 
``` 

```{r, mf_term_bp1_3_MOD_MODULE_NUMBER, echo=FALSE, eval="module_term_barplot_1" %in% section }
...
```{r, mf_term_bp2_1_MOD_MODULE_NUMBER, eval="module_term_barplot_2" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Func. enr. dotplot ")
``` 

```{r, mf_term_bp2_2_MOD_MODULE_NUMBER, eval="module_term_barplot_2" %in% section, echo=FALSE, results = "asis"}
knitr::asis_output("Dot plot of enriched terms.") 
``` 

```{r, mf_term_bp2_3_MOD_MODULE_NUMBER, echo=FALSE, eval="module_term_barplot_2" %in% section }
if(nrow(enrich_res) > 0){
  try_err <- try(enrichplot::dotplot(enrich_res, showCategory=15) + 
                   ggplot2::theme(axis.text.y = ggplot2::element_text(size=7)), silent = TRUE)
...
```{r, mf_term_table_1_MOD_MODULE_NUMBER, eval="term_table" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Func. enr. table ")
``` 

```{r, mf_term_table_2_MOD_MODULE_NUMBER, eval="term_table" %in% section, echo=FALSE, results = "asis"}
knitr::asis_output("A table with various information related to enrichment.") 
``` 

```{r, mf_term_table_3_MOD_MODULE_NUMBER, echo=FALSE, eval="term_table" %in% section }
