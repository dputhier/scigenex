...
FeaturePlot_params$object <- seurat_object
FeaturePlot_params$features <- "MOD_MODULE_NUMBER"
FeaturePlot_params$split.by <- NULL
base::do.call(Seurat::FeaturePlot, FeaturePlot_params)
...
vlnPlot_params$object <- seurat_object
vlnPlot_params$features <- "MOD_MODULE_NUMBER"
vlnPlot_params$split.by <- NULL
base::do.call(Seurat::VlnPlot, vlnPlot_params)
