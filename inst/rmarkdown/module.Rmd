...
<!-- NB: The code contains several global variables derived from scigenex_report() function arguments. -->
...
```{r, term_table_MOD_MODULE_NUMBER, eval="term_table" %in% section, echo=FALSE, results = "asis"} 
...
```{r, term_table_MOD_MODULE_NUMBER, echo=FALSE, eval="term_table" %in% section }
df_edo <- edo@result
