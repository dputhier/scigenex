...
```{r section_gen_info_6, echo=FALSE, eval="exp_info" %in% section,}
...
```{r, section_gen_info_7, eval="exp_info" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Sample informations") 
``` 
  
```{r, section_gen_info_8, eval="exp_info" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("This table display informations about the sample.") 
``` 

```{r section_gen_info_9, echo=FALSE, eval="exp_info" %in% section}
...
```{r, section_gen_info_10, eval="exp_info" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Workflow parameters.") 
``` 
  
```{r, section_gen_info_11, eval="exp_info" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("This table display informations about the worflow parameters.") 
``` 

```{r section_gen_info_12, echo=FALSE, eval="exp_info" %in% section}
...
```{r section_gen_info_13, echo=FALSE, eval="exp_info" %in% section}
...
```{r, section_gen_info_14, eval="exp_info" %in% section, echo=FALSE, results = "asis"} 
...
```{r section_gen_info_15, echo=FALSE, eval="exp_info" %in% section}
...
```{r, section_gen_info_16, eval="exp_info" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("### Module heatmap") 
``` 

```{r, section_gen_info_17, eval="exp_info" %in% section, echo=FALSE, results = "asis"} 
knitr::asis_output("A heatmap displaying representative genes (top genes) of each gene module.") 
``` 

```{r section_gen_info_18, echo=FALSE, eval="exp_info" %in% section}
