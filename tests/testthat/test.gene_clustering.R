...
test_that("Checking output slots generated by gene_clustering() using keep_nn as FALSE", {
  ...
  expect_that(res_no_keep_nn@parameters$noise_level, is_a("numeric"))
...
test_that("Checking output slots generated by gene_clustering() using keep_nn as TRUE", {
  ...
  expect_equal(res_keep_nn@parameters$noise_level, 0.3)
  expect_that(res_keep_nn@parameters$noise_level, is_a("numeric"))
