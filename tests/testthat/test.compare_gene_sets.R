...
test_that("Check diagrams are working (plot_cmp_genesets).", {
  ...
  expect_true(ggplot2::is_ggplot(plot_cmp_genesets(set_1 = set_1, set_2 = set_2, stat = "jaccard")))
  expect_true(ggplot2::is_ggplot(plot_cmp_genesets(set_1 = set_2, set_2 = set_1, stat = "jaccard")))
  expect_true(ggplot2::is_ggplot(plot_cmp_genesets(set_1 = set_2, set_2 = set_1, stat = "hypergeom")))
  expect_true(ggplot2::is_ggplot(plot_cmp_genesets(set_1 = set_2, set_2 = set_1, stat = "diff_set_1")))
  expect_true(ggplot2::is_ggplot(plot_cmp_genesets(set_1 = set_2, set_2 = set_1, stat = "diff_set_2")))
  expect_true(ggplot2::is_ggplot(plot_cmp_genesets(set_1 = set_2, set_2 = set_1, stat = "size_set_1")))
  expect_true(ggplot2::is_ggplot(plot_cmp_genesets(set_1 = set_2, set_2 = set_1, stat = "size_set_2")))
  expect_true(ggplot2::is_ggplot(plot_cmp_genesets(set_1 = set_2, set_2 = set_1, layout="square")))
})
