...
date: "`r Sys.Date()`"
title: "Creating Gene Module Reports with SciGeneX"
...
To use the `gm_report()` function, you need to load the **scigenex**, **Seurat**, and **org.Hs.eg.db** packages. The following code snippet demonstrates how to load these libraries.
